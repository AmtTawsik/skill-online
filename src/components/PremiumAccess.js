...
const PremiumAccess = () => {
  ...
  return (
    <>
      <h1 className="text-3xl md:text-7xl font-bold text-green-400 text-center">
        Checkout
      </h1>
      <hr />
      <form
        onSubmit={handelByeNow}
        className="card card-compact bg-base-100 shadow-xl md:w-2/6 mx-auto my-7"
      >
        <figure>
        ...
        <div className="card-body">
          ...
          <p className="text-lg flex items-center">
            Rating : {rating.rate} <FaStar></FaStar>
          </p>
          ...
          <input
            name="phone"
            type="text"
            placeholder="Your Phone Number to Confirm"
            className="input input-bordered input-accent w-full max-w-xs"
            required
          />
