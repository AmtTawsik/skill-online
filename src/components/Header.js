            ...
            <li>
                {
                    ...
                    :
                    <button className="px-5 py-2 rounded-lg text-xl font-bold text-gray-800 hover:text-gray-50 hover:bg-emerald-500">Login</button>
                }
            </li>

            <li>
                <button className="px-5 py-2 rounded-lg text-xl font-bold text-gray-800 hover:text-gray-50 hover:bg-emerald-500"><FaSignOutAlt></FaSignOutAlt></button>
            </li>
